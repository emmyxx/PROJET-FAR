...
SERVER_OBJ_FILES = $(BUILD_DIR)/serveur.o $(BUILD_DIR)/common.o $(BUILD_DIR)/gestionnaireClients.o $(BUILD_DIR)/routageMessageRecu.o
...
$(BUILD_DIR)/gestionnaireClients.o: $(SRC_DIR)/serveur/gestionnaireClients.c
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -c $< -o $@

$(BUILD_DIR)/routageMessageRecu.o: $(SRC_DIR)/serveur/routageMessageRecu.c
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -c $< -o $@
